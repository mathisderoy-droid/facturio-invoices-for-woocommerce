...
final class AdminOrderMetabox {
    ...
    public function __construct() {
        add_action('add_meta_boxes', [$this, 'register'], 20);
    }
    ...
    private function render_filled_state(\WC_Order $order, string $invoice_number, int $invoice_post_id): void {
        ...
        $confirm_text   = esc_attr__('La facture actuelle est conservée comme archive (obligation légale). Un nouveau numéro sera attribué à la nouvelle version. Continuer ?', 'factur-x-for-woocommerce');
