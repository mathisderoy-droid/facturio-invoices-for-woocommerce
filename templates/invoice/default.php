...
<table class="header-bar">
	<tr>
		...
		<td class="invoice-meta">
			<span class="label"><?php esc_html_e( 'FACTURE', 'mathisdd-compliant-invoices' ); ?></span><br>
			<span class="invoice-number"><?php echo esc_html( $invoice['number'] ); ?></span><br><br>
			<span class="label"><?php esc_html_e( 'Date d\'émission', 'mathisdd-compliant-invoices' ); ?></span><br>
			<?php echo esc_html( $invoice['issue_date_display'] ); ?><br><br>
			<?php if ( ! empty( $invoice['due_date_display'] ) ) : ?>
				<span class="label"><?php esc_html_e( 'Échéance', 'mathisdd-compliant-invoices' ); ?></span><br>
...
<table class="parties">
	<tr>
		<td>
			<h2><?php esc_html_e( 'Facturé à', 'mathisdd-compliant-invoices' ); ?></h2>
			<div class="party-box">
		...
		<td>
			<h2><?php esc_html_e( 'Mode de paiement', 'mathisdd-compliant-invoices' ); ?></h2>
			<div class="party-box">
...
<table class="lines" cellspacing="0">
	<thead>
		<tr>
			<th><?php esc_html_e( 'Description', 'mathisdd-compliant-invoices' ); ?></th>
			<th class="num"><?php esc_html_e( 'Qté', 'mathisdd-compliant-invoices' ); ?></th>
			<th class="num"><?php esc_html_e( 'Prix unit. HT', 'mathisdd-compliant-invoices' ); ?></th>
			<th class="center"><?php esc_html_e( 'TVA', 'mathisdd-compliant-invoices' ); ?></th>
			<th class="num"><?php esc_html_e( 'Total HT', 'mathisdd-compliant-invoices' ); ?></th>
		</tr>
	</thead>
	<tbody>
...
<table class="totals">
	<tr>
		<td><?php esc_html_e( 'Total HT', 'mathisdd-compliant-invoices' ); ?></td>
	...
	<?php foreach ( $tax_breakdown as $tax_row ) : ?>
		<tr>
			...
			<td><?php printf( esc_html__( 'TVA %s %%', 'mathisdd-compliant-invoices' ), esc_html( number_format_i18n( $tax_row['rate'], 2 ) ) ); ?></td>
			<td class="num"><?php echo esc_html( number_format_i18n( $tax_row['tax'], 2 ) ); ?> <?php echo esc_html( $invoice['currency_symbol'] ); ?></td>
		</tr>
	<?php endforeach; ?>
	<tr class="grand">
		<td><strong><?php esc_html_e( 'Total TTC', 'mathisdd-compliant-invoices' ); ?></strong></td>
	...
	<tr>
		<td><?php esc_html_e( 'Montant dû', 'mathisdd-compliant-invoices' ); ?></td>
