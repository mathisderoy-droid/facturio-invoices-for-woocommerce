...
<style>
	...
	h1 { font-size: 18pt; color: <?php echo esc_attr( $primary_color ); ?>; margin: 0; }
	h2 { font-size: 11pt; color: <?php echo esc_attr( $primary_color ); ?>; margin: 10px 0 4px 0; }
	...
	.invoice-number { font-size: 14pt; font-weight: bold; color: <?php echo esc_attr( $primary_color ); ?>; }
	.label { color: #888; font-size: 8pt; }
	.parties { margin-top: 18px; width: 100%; }
	.parties td { vertical-align: top; width: 50%; padding-right: 8px; }
	.party-box { background-color: #f7f7f9; padding: 8px; border-left: 3px solid <?php echo esc_attr( $primary_color ); ?>; }
	.lines { margin-top: 14px; }
	.lines th, .lines td { padding: 6px 8px; border-bottom: 1px solid #ddd; }
	.lines th { background-color: <?php echo esc_attr( $primary_color ); ?>; color: #fff; text-align: left; font-weight: bold; font-size: 9pt; }
	...
	.totals .grand { background-color: <?php echo esc_attr( $primary_color ); ?>; color: #fff; font-weight: bold; }
...
<table class="header-bar">
	<tr>
		...
		<td class="invoice-meta">
			<span class="label"><?php esc_html_e( 'FACTURE', 'facturio-invoices-for-woocommerce' ); ?></span><br>
			<span class="invoice-number"><?php echo esc_html( $invoice['number'] ); ?></span><br><br>
			<span class="label"><?php esc_html_e( 'Date d\'émission', 'facturio-invoices-for-woocommerce' ); ?></span><br>
			<?php echo esc_html( $invoice['issue_date_display'] ); ?><br><br>
			<?php if ( ! empty( $invoice['due_date_display'] ) ) : ?>
				<span class="label"><?php esc_html_e( 'Échéance', 'facturio-invoices-for-woocommerce' ); ?></span><br>
...
<table class="parties">
	<tr>
		<td>
			<h2><?php esc_html_e( 'Facturé à', 'facturio-invoices-for-woocommerce' ); ?></h2>
			<div class="party-box">
		...
		<td>
			<h2><?php esc_html_e( 'Mode de paiement', 'facturio-invoices-for-woocommerce' ); ?></h2>
			<div class="party-box">
...
<table class="lines" cellspacing="0">
	<thead>
		<tr>
			<th><?php esc_html_e( 'Description', 'facturio-invoices-for-woocommerce' ); ?></th>
			<th class="num"><?php esc_html_e( 'Qté', 'facturio-invoices-for-woocommerce' ); ?></th>
			<th class="num"><?php esc_html_e( 'Prix unit. HT', 'facturio-invoices-for-woocommerce' ); ?></th>
			<th class="center"><?php esc_html_e( 'TVA', 'facturio-invoices-for-woocommerce' ); ?></th>
			<th class="num"><?php esc_html_e( 'Total HT', 'facturio-invoices-for-woocommerce' ); ?></th>
		</tr>
	</thead>
	<tbody>
...
<table class="totals">
	<tr>
		<td><?php esc_html_e( 'Total HT', 'facturio-invoices-for-woocommerce' ); ?></td>
	...
	<?php foreach ( $tax_breakdown as $tax_row ) : ?>
		<tr>
			...
			<td><?php printf( esc_html__( 'TVA %s %%', 'facturio-invoices-for-woocommerce' ), esc_html( number_format_i18n( $tax_row['rate'], 2 ) ) ); ?></td>
			<td class="num"><?php echo esc_html( number_format_i18n( $tax_row['tax'], 2 ) ); ?> <?php echo esc_html( $invoice['currency_symbol'] ); ?></td>
		</tr>
	<?php endforeach; ?>
	<tr class="grand">
		<td><strong><?php esc_html_e( 'Total TTC', 'facturio-invoices-for-woocommerce' ); ?></strong></td>
	...
	<tr>
		<td><?php esc_html_e( 'Montant dû', 'facturio-invoices-for-woocommerce' ); ?></td>
